    ...
    <div>
      <header className="mx-auto text-xl text-white flex flex-col gap-4 items-center justify-center py-2 px-8 border-b-[#f8daac] bg-slate-900 bg-opacity-50 backdrop-blur-sm">
        <div className="container mx-auto flex justify-between items-end">
          <div className="flex flex-col gap-2 items-center w-[160px] max-md:w-[100px]">
            <Link href="/">
              <Image
            ...
            <div className="text-sm max-md:text-[12px]">有限会社 石和工業</div>
          </div>
          <ul className="flex gap-8 max-md:flex-col max-md:gap-0">
